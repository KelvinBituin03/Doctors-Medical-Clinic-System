    ...
    public partial class ForgotPassword : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                conn.Open();
                MySqlCommand comm = new MySqlCommand("Select * from databaseitu.users where Username='" + textBox1.Text + "'and SecretQuestion='" + comboBox1.Text + "'and SecretAnswer='" + textBox2.Text + "'", conn);
